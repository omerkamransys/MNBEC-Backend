...
namespace MNBEC.API.WEBAPI
{
    ...
    public class Startup
    {
        ...
        public async void ConfigureServices(IServiceCollection services)
        {
            ...
            // Changed for DI error on IQuotationServiceConnector error in CustomerApplication 
            // services.RegisterCacheService(this.Configuration);
            ...
            services.RegisterConfigurationApplication();
            services.RegisterEmailApplication();

            services.RegisterAccountInfrastructure();
            services.RegisterConfigurationInfrastructure();

            services.RegisterQuestionnaireTemplateApplication();
            services.RegisterQuestionnaireTemplateInfrastructure();
            ...
            services.RegisterAnswerApplication();
            services.RegisterAnswernfrastructure();
